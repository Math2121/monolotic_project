...
import GenerateInvoiceUseCase from "../../modules/invoice/usecase/generate/generate.usecase";
import InvoiceRepository from "../../modules/invoice/gateway/repository/invoice.repository";
import FindUseCaseInvoice from "../../modules/invoice/usecase/find/find.usecase";
...
invoiceRoute.get("/:invoiceId", async (req: Request, res: Response) => {
    const usecase = new FindUseCaseInvoice(new InvoiceRepository());
